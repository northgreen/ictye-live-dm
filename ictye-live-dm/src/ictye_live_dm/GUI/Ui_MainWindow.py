...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.location.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:x-large; font-weight:600;\">Location </span><a href=\"http://127.0.0.1:8082\"><span style=\" text-decoration: underline; color:#0000ff;\">http://127.0.0.1:8082</span></a></p></body></html>"))
